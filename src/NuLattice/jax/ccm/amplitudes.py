...
def t2_H2_ppph(H2, t1, t2, v_ppph, shard_pphh):
    ...
    d3_int = with_sharding_constraint(d3_int, shard_pphh)
    H2 = add_AB(H2, -d3_int)
    ...
    d4_int = with_sharding_constraint(d4_int, shard_pphh)
    ...
    d5_int = with_sharding_constraint(d5_int, shard_pphh)
    ...
    d6_int = with_sharding_constraint(d6_int, shard_pphh)
...
def t2_H2_dense_part3(H2, t1, t2, v_pphh, v_phph, v_phhh, v_hhhh, shard_pphh, shard_phph):
    ...
    d11 = with_sharding_constraint(d11, shard_pphh)
    ...
    d12 = with_sharding_constraint(d12, shard_pphh)
    ...
    d13 = with_sharding_constraint(d13, shard_pphh)
    ...
    d14 = with_sharding_constraint(d14, shard_pphh)
    H2 = add_AB_IJ(H2, d14)
    ...
    d15 = with_sharding_constraint(d15, shard_pphh)
