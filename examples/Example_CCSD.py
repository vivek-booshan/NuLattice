...
def parse():
    ...
    parser.add_argument("--use_ham", type=bool, default=True, help="Whether to normal order with hamiltonians (true) or from contacts (false)")
...
def main():
    ...
    refEn, focks, contacts = solver.normal_order(args.use_ham)
